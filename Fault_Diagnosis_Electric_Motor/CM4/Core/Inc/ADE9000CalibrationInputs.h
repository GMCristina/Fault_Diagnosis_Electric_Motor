...
#ifndef INC_ADE9000_CALIBRATIONINPUTS_H_
#define INC_ADE9000_CALIBRATIONINPUTS_H_
...
*****************************************************************************************************************/
#define CAL_IRMS_CC		(10^6/(CURRENT_TRANSFER_FUNCTION*ADE9000_RMS_FULL_SCALE_CODES*SQRT(2)))					// (uA/code)
#define CAL_VRMS_CC		(10^6/(VOLTAGE_TRANSFER_FUNCTION*ADE9000_RMS_FULL_SCALE_CODES*SQRT(2)))				// (uV/code)
#define CAL_POWER_CC 	(10^3/(CURRENT_TRANSFER_FUNCTION*VOLTAGE_TRANSFER_FUNCTION*ADE9000_WATT_FULL_SCALE_CODES*2))					// (mW/code) Applicable for Active, reactive and apparent power
#define CAL_ENERGY_CC	(10^6/(CURRENT_TRANSFER_FUNCTION*VOLTAGE_TRANSFER_FUNCTION*ADE9000_WATT_FULL_SCALE_CODES*2*8000*3600*2^-13))					// (uWhr/xTHR_HI code)Applicable for Active, reactive and apparent energy
